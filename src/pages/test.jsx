...
export default function TestPage() {
   ...
   return (
      <div className="w-full h-full flex justify-center items-center">
         <input
            type="file"
            className="border border-gray-300 rounded-md p-2 cursor-pointer hover:border-gray-400"
            onChange={(e) => {
         ...
         <button
            ...
            className="bg-red-500 p-2 text-white rounded-2xl cursor-pointer hover:bg-red-800">
            Upload
         </button>
      </div>
   );
         ...
         <div className="w-[800px] bg-accent/80 rounded-2xl p-10">
            ...
            <div className="w-full bg-amber-50 p-5 rounded-xl flex flex-wrap justify-between">
               ...
               <button
                  onClick={addProduct}
                  disabled={loading}
                  className={`w-[49%] h-12 text-white font-bold rounded-2xl mt-5 flex justify-center items-center text-center transition-all duration-200 ${
                     loading 
